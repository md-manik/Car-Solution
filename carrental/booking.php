     ...
     <hr>
      ...
      <form action="confirm_booking.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input required type="date" class="form-control" name= "start_date" placeholder= "start_date">
         </div>
         ...
         <div class="form-group">
            ...
            <input required type="date" class="form-control" name= "end_date" placeholder= "end_date">
         </div>
