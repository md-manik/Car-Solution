...
<div class= "container">
  <div class= "row">
     ...
     <h2> Editing Carwash Details</h2>
     <hr>

      <form action="updateCarwash.php?carwash_id=<?php echo $carwash_id ?>" method="POST">

        <div class="form-group">
            <label for="carwash_name"> Carwash Name : </label>
            <input required type="text" class="form-control" name= "carwash_name" placeholder= "carwash_name" value="<?php echo $cwd['carwash_name']?>">
        </div>

         <div class="form-group">
            <label for="carwash_price"> Price : </label>
            <input required type="text" class="form-control" name= "carwash_price" placeholder= "carwash_price" value="<?php echo $cwd['carwash_price']?>">
         </div>
