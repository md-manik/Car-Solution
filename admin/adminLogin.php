           ...
           <?php  } ?>
            ...
            <form action="confirmAdminLogin.php" method="post">
               ...
               <div class="form-group">
                    ...
                    <input required type="text" class="form-control" name="admin_name" placeholder="admin_name">
                  </div>
                 <!-- <div class="form-group">
               ...
               <input requirued type="password" class="form-control" name="admin_password" placeholder="password">
               </div>
